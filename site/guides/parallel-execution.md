...
{: .warning }
When you run `autospec specify` or `autospec run`, the command creates a new feature branch and **automatically checks it out**. This is critical to understand when planning parallel workflows.
